...
function LogoSevenGroup({ isMouseEntered, isFacingUser, setIsFacingUser, isClickToggled, guiy, isSmallScreen }: Props) {
  ...
  return (
    <group position={[0, 0, 0]} scale={[1.0, 1.0, 1.0]} ref={logoSevenGroupRef}>
      ...
      <Text text={'Darmstadtium'} position={[0, 0.1, -0.3]} rotation={new THREE.Euler(0, Math.PI, 0)} size={0.4} depth={0.5} textMaterialProps={textMaterialProps} />
      <Text text={'281'} position={[0, -0.6, -0.3]} rotation={new THREE.Euler(0, Math.PI, 0)} size={0.4} depth={0.5} textMaterialProps={textMaterialProps} />
